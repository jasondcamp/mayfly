...
echo "==> building + importing mayfly images (dragonfly, hello, caddis) at ${V}"
...
k3d image import ghcr.io/jasondcamp/mayfly-dragonfly:${V} ghcr.io/jasondcamp/mayfly-hello:${V} ghcr.io/jasondcamp/mayfly-caddis:${V} ghcr.io/jasondcamp/mayfly-caddis-frontend:${V} -c "$CLUSTER"
